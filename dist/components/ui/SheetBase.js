...
const SheetBase = SheetPrimitive.Root;
const SheetTriggerBase = SheetPrimitive.Trigger;
const SheetCloseBase = SheetPrimitive.Close;
const SheetPortalBase = SheetPrimitive.Portal;
const SheetOverlayBase = React.forwardRef(({ className, ...props }, ref) => (_jsx(SheetPrimitive.Overlay, { className: cn("fixed inset-0 z-50 bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", className), ...props, ref: ref })));
...
const SheetContentBase = React.forwardRef(({ side = "right", className, children, ...props }, ref) => (_jsxs(SheetPortalBase, { children: [_jsx(SheetOverlayBase, {}), _jsxs(SheetPrimitive.Content, { ref: ref, className: cn(sheetVariants({ side }), className), ...props, children: [_jsxs(SheetPrimitive.Close, { className: "absolute right-4 top-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary", children: [_jsx(X, { className: "h-4 w-4" }), _jsx("span", { className: "sr-only", children: "Close" })] }), children] })] })));
SheetContentBase.displayName = SheetPrimitive.Content.displayName;
const SheetHeaderBase = ({ className, ...props }) => (_jsx("div", { className: cn("flex flex-col space-y-2 text-center sm:text-left", className), ...props }));
SheetHeaderBase.displayName = "SheetHeaderBase";
const SheetFooterBase = ({ className, ...props }) => (_jsx("div", { className: cn("flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2", className), ...props }));
SheetFooterBase.displayName = "SheetFooterBase";
const SheetTitleBase = React.forwardRef(({ className, ...props }, ref) => (_jsx(SheetPrimitive.Title, { ref: ref, className: cn("text-lg font-semibold text-foreground", className), ...props })));
SheetTitleBase.displayName = SheetPrimitive.Title.displayName;
const SheetDescriptionBase = React.forwardRef(({ className, ...props }, ref) => (_jsx(SheetPrimitive.Description, { ref: ref, className: cn("text-sm text-muted-foreground", className), ...props })));
