...
export function MonthView({
  ...
  const weekdays = useMemo(() => {
    return Array.from({ length: 7 }).map((_, i) => {
      ...
      // use pt-BR locale and capitalize first letter
            ...
            {week.map((day, dayIndex) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="mt-1 inline-flex w-7 h-7 items-center justify-center rounded-full text-sm font-semibold text-muted-foreground group-data-today:bg-primary group-data-today:text-primary-foreground">
                      {format(day, "d")}
                    </div>
                    <div
