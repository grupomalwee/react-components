  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        {leftIcon && (
          <span className="flex-shrink-0 [&>svg]:size-4">{leftIcon}</span>
        )}
        <span>{children}</span>
      </div>
      {showCaret && (
        <span className="caret-icon flex-shrink-0 transition-transform duration-500 ease-in-out">
...
CollapsibleTriggerBase.displayName =
...
CollapsibleContentBase.displayName =
