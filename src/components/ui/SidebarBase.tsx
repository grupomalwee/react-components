...
const SidebarProviderBase = React.forwardRef<
  HTMLDivElement,
  ...
  (
    ...
    return (
      <SidebarContext.Provider value={contextValue}>
        <TooltipProviderBase delayDuration={0}>
          <div
            style={
              {
...
>(
  (
    ...
    if (isMobile) {
      return (
        <SheetBase open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContentBase
...
const SidebarTriggerBase = React.forwardRef<
...
const SidebarRailBase = React.forwardRef<
  HTMLButtonElement,
...
const SidebarInsetBase = React.forwardRef<
  HTMLDivElement,
...
const SidebarInputBase = React.forwardRef<
...
const SidebarHeaderBase = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => {
  return (
...
const SidebarFooterBase = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => {
  return (
...
const SidebarSeparatorBase = React.forwardRef<
...
const SidebarContentBase = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => {
  return (
...
const SidebarGroupBase = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => {
  return (
...
const SidebarGroupLabelBase = React.forwardRef<
  HTMLDivElement,
...
const SidebarGroupActionBase = React.forwardRef<
  HTMLButtonElement,
...
const SidebarGroupContentBase = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => (
  <div
...
const SidebarMenuBase = React.forwardRef<
  HTMLUListElement,
...
const SidebarMenuItemBase = React.forwardRef<
  HTMLLIElement,
...
const SidebarMenuButtonBase = React.forwardRef<
  HTMLButtonElement,
  React.ComponentProps<"button"> & {
    asChild?: boolean;
    isActive?: boolean;
...
>(
  (
    ...
    return (
      <TooltipBase>
        <TooltipTriggerBase asChild>{button}</TooltipTriggerBase>
        <TooltipContentBase
          side="right"
          align="center"
...
const SidebarMenuActionBase = React.forwardRef<
  HTMLButtonElement,
  React.ComponentProps<"button"> & {
    asChild?: boolean;
    showOnHover?: boolean;
...
const SidebarMenuBadgeBase = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => (
  <div
...
const SidebarMenuSubBase = React.forwardRef<
  HTMLUListElement,
  React.ComponentProps<"ul">
>(({ className, ...props }, ref) => (
  <ul
...
const SidebarMenuSubItemBase = React.forwardRef<
  HTMLLIElement,
  React.ComponentProps<"li">
>(({ ...props }, ref) => <li ref={ref} {...props} />);
SidebarMenuSubItemBase.displayName = "SidebarMenuSubItemBase";

const SidebarMenuSubButtonBase = React.forwardRef<
  HTMLAnchorElement,
