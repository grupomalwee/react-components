...
import Changelog from "@/components/ui/Changelog"; // Import default se o export for default

const meta: Meta<typeof Changelog> = {
  title: "Changelog", // Mantendo o título simples para bater com o ID antigo
  component: Changelog,
  tags: ["!autodocs"],
  parameters: { 
    layout: "fullscreen",
