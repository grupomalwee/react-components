...
//   },
  parameters: {
    docs: {
      source: {
        code: "// Template em desenvolvimento — conteúdo em revisão",
      },
    },
  },
  render: () => (
    <div className="p-6 font-sans">
      <div className="mx-auto max-w-xl rounded-lg border border-yellow-300 bg-yellow-50 p-6 shadow-sm">
        <h2 className="mb-2 text-lg font-semibold text-yellow-900">
          Template em desenvolvimento
        </h2>
        <p className="text-sm text-yellow-800">
          Este template está em desenvolvimento e será disponibilizado em breve.
          Obrigado pela paciência — fique de olho nas próximas atualizações.
        </p>
