...
const meta: Meta<typeof PopoverBase> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Popover para exibir conteúdo flutuante, formulários e listas.",
      },
    },
    backgrounds: {
      default: "light",
...
// Snippet consumer-facing para Popover
meta.parameters = {
  ...meta.parameters,
  docs: {
...
import { PopoverBase, PopoverTriggerBase, PopoverContentBase } from '@mlw-packages/react-components';
