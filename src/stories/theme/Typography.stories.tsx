    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-muted p-8">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
          ...
          <p className="font-sans text-2xl">Gentle lions admire tall zebras</p>
        ...
        <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
          ...
          <p className="font-serif text-2xl">Gentle lions admire tall zebras</p>
        ...
        <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
          ...
          <p className="font-mono text-2xl">Gentle lions admire tall zebras</p>
